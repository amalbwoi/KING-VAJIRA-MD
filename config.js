...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '918075486429';
...
global.gurl = 'https://youtube.com/shorts/hkp1iHGd6ms?si=Gn1TIKgdYmquN-a7' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '918075486429'; ;
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/JweQX8Z.jpeg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;CostaGoddess
	",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'NEXO-XER',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x nexo`,
  author:  process.env.PACK_AUTHER || '',
  autovoice: process.env.AUTO_VOICE || 'false',
  errorChat : process.env.ERROR_CHAT|| '', // put 'chat' here to send error in chat ,where it accures
  read_status : process.env.AUTO_READ_STATUS || 'false',
  save_status : process.env.AUTO_SAVE_STATUS || 'false',
  packname:  process.env.PACK_NAME || "\t   𓅋 nexo 𓃮 \n\nᴋɪss ʍᴇ...💋\n\nᴄʟօsᴇ ყσυɾ ᴇყᴇs...👁️🙈\n\nʍɪss ʍᴇ...♥️\n\n\n   -ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ᴛᴀᴋᴇ 🚮 \n\n--- ρυвʟɪᴄ вσт нᴇʀᴇ ---" ,
